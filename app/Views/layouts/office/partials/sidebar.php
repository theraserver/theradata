<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="<?= site_url('/') ?>">
                <img src="<?= site_url('assets') ?>/static/theralogo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item<?= $uri->getSegment(1) === 'admin' && $uri->getSegment(2) === 'dashboard' ? ' active' : null ?> ">
                    <a class="nav-link<?= $uri->getSegment(1) === 'admin' && $uri->getSegment(2) === 'dashboard' ? ' active' : null ?>" href="<?= url_to('dashboard') ?>/">
                ...
                <li class="nav-item <?= $uri->getSegment(2) === 'company' ? 'active' : '' ?> dropdown">
                    <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu <?= $uri->getSegment(2) === 'company' ? 'show' : '' ?>">
                        <a class="dropdown-item<?= $uri->getSegment(3) === 'stores' ? ' active' : '' ?>" href="<?= url_to('company.store') ?>">
                            Cabang
                        </a>
                        <a class="dropdown-item" href="#">
                            Gudang
                ...
                <li class="nav-item <?= $uri->getSegment(2) === 'setting' ? 'active' : '' ?> dropdown">
                    <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    ...
                    <div class="dropdown-menu <?= $uri->getSegment(2) === 'setting' ? 'show' : '' ?>">
                        <a class="dropdown-item <?= $uri->getSegment(2) === 'setting' ? 'active' : '' ?>" href="<?= url_to('setting') ?>">
                            Umum
                        </a>
                    </div>
                </li>
